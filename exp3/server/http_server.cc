 ...
 public:
  int Initialize() override {
    ...
    auto SetHttpRoutes = [file_storage_handler](::trpc::http::HttpRoutes& r) -> void {
      ...
      // DHT-style shard upload/download and local wordcount.
      r.Add(::trpc::http::MethodType::POST, ::trpc::http::Path("/upload_shard"), file_storage_handler);
      r.Add(::trpc::http::MethodType::GET, ::trpc::http::Path("/download_shard"), file_storage_handler);
      r.Add(::trpc::http::MethodType::GET, ::trpc::http::Path("/wordcount_local"), file_storage_handler);
      // Map-Reduce wordcount map endpoint.
      r.Add(::trpc::http::MethodType::POST, ::trpc::http::Path("/wordcount/map"), file_storage_handler);
    };
